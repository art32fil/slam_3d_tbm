...
TBM3::TBM3(double a, double b, double c, double ab, double ac, double bc, double abc):
...
TBM3 operator +(const TBM3& a, const TBM3& b) {
	...
	TBM3::mass_t mass_zero = a.a*b.b + a.a*b.c + a.a*b.bc +
	                         ...
	                         a.ab*b.c + a.ac*b.b + a.bc*b.b;
	TBM3::mass_t summ = mass_a + mass_b + mass_b +
